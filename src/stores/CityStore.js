...
const CityStore = {
	...
	loadData: function (cityId, selectedByUser) {
		...
		this.dataLoader.query([
			...
			this.data.bucketPath = 'http://holc.s3-website-us-east-1.amazonaws.com/tiles/' + CitiesStore.getState(this.data.id) + '/' + CitiesStore.getCityName(this.data.id).replace(/\s+/g, '')  + '/' + CitiesStore.getYear(this.data.id) + '/';
